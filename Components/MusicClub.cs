...
namespace Vereinsportal.Components
{
    ...
    {
        private Club _club;
        private MusicRegister _musicData;
        ...
        public MusicClub setMusicRegister(IDataRegister musicData) { _musicData = (MusicRegister)musicData; return this;}
        public Club setStatus(Club.ClubStatus status) { _club.setStatus(status); return _club; }


        public MusicClub() => _club = new Club();
